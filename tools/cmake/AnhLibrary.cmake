# AddAnhLibrary is a standardized way to build libraries in the MMOServer
...
#               PROJECT_DEPS [ARGS] [args1...]             # Dependencies on other MMOServer projects
...
FUNCTION(AddAnhLibrary name)
    ...
    LIST(LENGTH ANHLIB_PROJECT_DEPS _project_deps_list_length)
    ...
    IF(_sources_list_length GREATER 0)
        FOREACH(_source_dir ${ANHLIB_ADDITIONAL_SOURCE_DIRS})
    ...
    IF(_project_deps_list_length GREATER 0)
        ADD_DEPENDENCIES(${name} ${ANHLIB_PROJECT_DEPS})
    ENDIF()
