...
# an Anh project. Particularly on windows platforms this manages all the
...
#                        PROJECT_DEPS [ARGS] [args1...]           # Dependencies on other Anh projects
...
FUNCTION(AddAnhExecutable name)
    ...
    IF(_project_deps_list_length GREATER 0)
        TARGET_LINK_LIBRARIES(${name} ${ANHLIB_PROJECT_DEPS})
    ENDIF()
